...
@section('header')
    ...
    <a href="#" class="text_grey">Detail Pengaduan</a>
@endsection
                ...
                <div class="card-body">
                    <form action="{{route('tanggapan.createOrUpdate')}}" method="POST">
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="tanggapan" id="tanggapan" rows="3" class="form-control" placeholder="Belum Ada Tanggapan">{{ $tanggapan->tanggapan ?? ''}}</textarea>
                        </div>
